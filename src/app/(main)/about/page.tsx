...
const AboutMe = () => {
   return (
      <div className="flex min-h-screen flex-col lg:ml-60">
         {/* top section */}
         <motion.div 
            className="relative flex justify-start items-start mt-20 flex-col"
         ...
         <div className="flex gap-10 justify-center h-full py-5 my-5 flex-col xl:flex-row">
            <motion.div 
               className="min-w-60 lg:min-w-90"
            ...
            <motion.div 
               className="text-lg bg-black/60 px-3 py-1 shadow-inner shadow-gray-500 space-y-4"
            ...
            >
               ...
               >
                  I've always believed great developers aren't born — they're shaped. My journey began in Agadir, where I earned my <span className="bg-blue-600 p-1">Bachelor's degree</span> in Mathematics & Computer Science. But things truly clicked when I joined <Link href="https://1337.ma/en/" target="_blank" className="relative bg-pink-600 p-1 hover:bg-pink-700 transition-colors group">1337 Coding School<span className="absolute -top-8 left-1/2 -translate-x-1/2 bg-pink-900 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none">Visit website</span></Link>: no teachers, no traditional system — just problem-solving, peers, and pure logic.
               </motion.p>
               ...
               >
                  For two years, I lived in that environment: late-night debugging, intense peer reviews, and projects that forced me to grow fast. It taught me <span className="bg-yellow-500 p-1 text-gray-800">discipline</span>, <span className="bg-yellow-500 p-1 text-gray-800">autonomy</span>, and one clear truth — I genuinely love building things.
               </motion.p>
               ...
               >
                  What drives me is simple: creating smooth, predictable, and high-quality user experiences. Whether it's a dashboard, an internal tool, or a production app, I focus on performance, clarity, and the details that make software feel professional.
               </motion.p>
               ...
               >
                  I enjoy teamwork, ownership, and delivering beyond expectations. I code because I love the craft, I build because I love the impact — and every project is my chance to raise the bar.
               </motion.p>
            </motion.div>
         </div>
      </div>
