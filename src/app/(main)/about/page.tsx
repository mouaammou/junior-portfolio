const AboutMe = () => {
   ...
   return (
      <div className="flex min-h-screen flex-col lg:ml-60 p-10">
         {/* top section */}
         ...
         {/* main content */}
         <div className="flex gap-10 justify-center max-h-[30rem] h-full py-5  my-5 max-md:flex-col">
            <div>
               <img src="/mouaad.jpg" alt="profile page" className="w-[50rem]"/>
            </div>
            <div>
