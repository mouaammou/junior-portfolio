            ...
            return (
              ...
              >
                <div className="mb-3 md:mb-4 overflow-hidden">
                  ...
                  <div className="bg-gradient-to-r from-yellow-400 via-yellow-300 to-transparent h-1 w-0 group-hover:w-full transition-all duration-700 ease-linear mt-2"></div>
                </div>
                
                <div className="relative w-full h-120 md:h-56 lg:h-120 overflow-hidden rounded-lg border border-gray-700/50 group-hover:border-yellow-400/60 transition-all duration-300 shadow-lg group-hover:shadow-yellow-400/20">
                  <Image
                    width={400}
                    height={256}
